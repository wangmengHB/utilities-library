...
function polyfill() {
  ...
  function supportsOESTextureFloatLinear(gl: WebGLRenderingContext) {
  ...
  function getOESTextureFloatLinear(gl: WebGLRenderingContext) {
    if ((gl as any).$OES_texture_float_linear$ === void 0) {
    ...
    return (gl as any).$OES_texture_float_linear$;
  }

  // This replaces the real getExtension()
  function getExtension(this: WebGLRenderingContext, name: string) {
  ...
  function getSupportedExtensions(this: WebGLRenderingContext) {
    if ( !(this instanceof WebGLRenderingContext) ) {
  ...
  // Get a WebGL context 
  let oldGetExtension: Function;
  let oldGetSupportedExtensions: Function;
  ...
  const oldExtensions = gl.getSupportedExtensions();
