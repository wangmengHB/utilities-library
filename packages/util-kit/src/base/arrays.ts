...
/*
  calculate all posible combinations of element from the source array's, and return the result. 
  the result is another array, and each element represent the combination.
  example: ['a', 'b'] --> [['a'], ['b'], ['a', 'b']]
*/
...
/*
  calculate possible permutations of elment from the source array and return the result.
  example: ['a', 'b'] --> [['a', 'b'], ['b', 'a']]
*/
...
/*
  calculate all possible combinations of the source array,
  and then calculate all possible permutations of the first step result,
  then return all the comb-permutations. 
