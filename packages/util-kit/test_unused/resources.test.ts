...
import { dirname, basename, distinctParents, joinPath, isEqual, isEqualOrParent, hasToIgnoreCase, normalizePath, isAbsolutePath, relativePath, removeTrailingPathSeparator, hasTrailingPathSeparator, resolvePath, addTrailingPathSeparator } from '../lib/base/resources';
import { URI } from '../lib/base/uri';
import { isWindows } from '../lib/base/platform';
import { toSlashes } from '../lib/base/extpath';
import { startsWith } from '../lib/base/strings';
import { win32, posix } from '../lib/base/path';
